...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference("Subcategory.count") do
      post subcategories_url, params: { subcategory: { subcategory_description: @subcategory.subcategory_description, subcategory_topic: @subcategory.subcategory_topic } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { subcategory_description: @subcategory.subcategory_description, subcategory_topic: @subcategory.subcategory_topic } }
